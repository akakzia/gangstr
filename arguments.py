...
def get_args():
    ...
    parser.add_argument('--algo', type=str, default='value_disagreement', help="'hme', 'value_disagreement', 'lp'")
    ...
    parser.add_argument('--episode-duration', type=int, default=40, help='number of time steps for each episodes')
    ...
    parser.add_argument('--ss-internalization-prob', type=float, default=0.0, help='the probability of internalizing stepping stones')
